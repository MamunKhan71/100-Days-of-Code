...
import html
data = QuestionData()
question = data.questionFetcher()
print(question)
quizBrain = QuizBrain(question)
# window = Tk()
...
# rightButton = Button(image=rImage, borderwidth=0, command=quizBrain.rightButton)
# rightButton.grid(row=2, column=1)
# lImage = PhotoImage(file="./images/false.png")
#
# leftButton = Button(image=lImage, borderwidth=0, command=quizBrain.leftButton)
